...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://iili.io/dmKqfTP.jpg'
module.exports = {
  ...
  alivepic: process.env.ALIVE_IMG || 'https://iili.io/dmKqfTP.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY NARUTO-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'PRABATH',
  sessionName: process.env.SESSION_ID || 'PRABATH-MD~Jdo0BbiS#KnSuHgVSea489wqeZcp6TC-s6TYi9V-sgA6ht97ByGc',
  author: process.env.PACK_INFO.split(";")[0] || '𝙻𝙾𝚄𝙺𝚂𝙾𝙽 𝚄𝚉𝚄𝙼𝙰𝙺𝙸', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'false',
  packname: process.env.PACK_INFO.split(";")[1] || '𝙻𝙾𝚄𝙺𝚂𝙾𝙽 𝚄𝚉𝚄𝙼𝙰𝙺𝙸',
